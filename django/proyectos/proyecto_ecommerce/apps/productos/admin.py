...
class CategoriaAdmin(admin.ModelAdmin):
    ...
    # Corregido: Se elimina 'slug' de readonly_fields para permitir prepopulated_fields
...
class ImagenInline(admin.TabularInline):
    ...
    model = Imagen
    extra = 3  # Permite subir 3 imágenes extra directamente
    fields = ["imagen", "orden"]
    ordering = ["orden"]
...
class ProductoAdmin(admin.ModelAdmin):
    ...
    # Corregido: Se elimina 'slug' de readonly_fields
    readonly_fields = ["created_at", "updated_at"]
    prepopulated_fields = {"slug": ("nombre",)}
